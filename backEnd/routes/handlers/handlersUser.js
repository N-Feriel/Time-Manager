...
const getUsers = async (req, res) => {
  ...
  if (!users)
    return res
      .status(400)
      .json({ status: 400, message: "can't find users dataBase" });
...
const createUser = async (req, res) => {
  ...
  return res
    ...
    .json({
      status: 201,
      data: _.pick(user, ["first_name", "last_name", "isAdmin", "email"]),
    });
};
...
module.exports = { getUsers, getUser, createUser, authUser };
